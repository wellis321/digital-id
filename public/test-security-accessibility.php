...
// Ensure RateLimiter is loaded for testing
if (file_exists(dirname(__DIR__) . '/src/classes/RateLimiter.php')) {
    require_once dirname(__DIR__) . '/src/classes/RateLimiter.php';
}
