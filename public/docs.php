...
<div class="docs-container">
    <aside class="docs-sidebar">
        ...
        <ul>
            ...
            <li><a href="<?php echo url('docs.php?section=staff-service'); ?>" class="<?php echo $section === 'staff-service' ? 'active' : ''; ?>">
                <i class="fas fa-users"></i> Staff Service Integration
            </a></li>
            <li><a href="<?php echo url('docs.php?section=building-access'); ?>" class="<?php echo $section === 'building-access' ? 'active' : ''; ?>">
                <i class="fas fa-door-open"></i> Building Access Integration
            </a></li>
      ...
      "env": {
        ...
        <?php elseif ($section === 'user-stories'): ?>
            ...
            <div class="success-box" style="margin-top: 2rem;">
                ...
                <ul style="margin-top: 0.5rem;">
                    <li><strong>Building access systems:</strong> QR code and NFC integration for turnstiles and door access (see <a href="<?php echo url('docs.php?section=building-access'); ?>">Building Access Integration</a>)</li>
        ...
        <?php elseif ($section === 'staff-service'): ?>
...
0 * * * * cd /path/to/digital-id && php scripts/sync-staff-service.php >> /var/log/staff-sync.log 2>&1</code></pre>
        ...
        <?php elseif ($section === 'building-access'): ?>
...
if success:
    ...
    deny_access(message)</code></pre>
            ...
            <h2>Support</h2>
            <p>For integration support or questions about the Building Access API, contact your organisation administrator or refer to the <a href="<?php echo url('docs.php?section=troubleshooting'); ?>">Troubleshooting</a> guide.</p>
